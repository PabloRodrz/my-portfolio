      ...
      {isDesktop > 992 ?
        <>
          ...
          <Row className="gap-5">
            <Col className="d-flex align-items-center justify-content-end" xs={4}>
              <Image className="p-2 about-img" src="src\assets\foto_cv.jpg" alt="my-picture" />
            </Col>
        ...
        <Row>
          <Col xs={12} className="d-flex flex-column justify-content-center align-items-center">
            <span className="about-span-intro">Let me introduce myself</span>
            <h1 className='about-h1 text-white'>About me  <hr className="about-hr" /></h1>
            <Image className="p-2 about-img-mobile rounded-5" src="src\assets\foto_cv.jpg" alt="my-picture" />
